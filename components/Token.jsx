					...
					<div className='col-12'>
						<div className='invest invest--big'>
							...
							<p className='invest__info'>
								...
								Laboriosam, rerum? Animi laboriosam natus autem quos tenetur
								atque. Eligendi quibusdam fuga inventore, ullam ipsam sed
								pariatur provident voluptas eius, a iure?
							</p>
						</div>
					</div>
				</div>
