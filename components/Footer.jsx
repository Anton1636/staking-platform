				...
				<div className='row'>
					<div className='col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-1 order-lg-4 order-xl-1'>
						...
						<p className='footer__tagline'>
							...
							minus iusto. Expedita at magni et id illo nisi vel reprehenderit
							animi corrupti aliquam, debitis repellat voluptas adipisci quam,
							laudantium harum!
						</p>
					</div>
					<div className='col-6 col-md-4 col-lg-3 col-xl-2 order-3 order-md-2 order-lg-2 order-xl-3 offset-md-2 offset-lg-0'>
						...
						<div className='footer__nav'>
							<a href='#'>About Centre</a>
							<a href='#'>Our news</a>
							<a href='#'>License</a>
							<a href='#'>Contacts</a>
						</div>
					</div>
					<div className='col-12 col-md-8 col-lg-6 col-xl-4 order-2 order-md-2 order-lg-1 order-xl-2'>
						<div className='row'>
					...
					<div
						className='col-6 col-md-4 col-lg-3 col-xl-2 order-4 order-md-4
					order-lg-3 order-xl-4 '
					>
