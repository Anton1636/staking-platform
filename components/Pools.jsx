...
const Pools = (setPoolID, poolDetails, setSelectedPool, selectedToken) => {
					...
					<div className='col-12 col-md-8 offset-md-2 col-xl-6 offset-lg-3'>
						<div className='section__title'>
							...
							<p>
								...
								Molestiae incidunt deleniti voluptatibus .
							</p>
						</div>
					</div>
				</div>
			...
			<div className='row'>
				{poolArray.map((pool, index) => (
					<div
						key={index}
						className={`col-12 ${
							index === 0 || index === 1 ? 'col-md-6' : index === 2 ? '' : ''
						} col-lg-4`}
					>
						<div className='apool'>
							...
							<ul
								className={`nav nav-tabs apool_tabs apool__tabs--${
									index == 0
										? 'orange'
										: index == 1
										? 'green'
